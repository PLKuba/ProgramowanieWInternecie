...
export const MagicButton = ({
  ...
  title: string; icon: React.ReactNode; position: string; handleClick?: (e: React.MouseEvent) => void; otherClasses?: string
}) => {
    return (
      <button className="relative inline-flex h-12 max-w-full overflow-hidden rounded-lg p-[1px] focus:outline-none md:mt-10">
